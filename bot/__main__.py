...
def stats(update, context):
    ...
    stats = f'<b>𝐁𝐎𝐓 𝐔𝐏𝐓𝐈𝐌𝐄:</b> {currentTime}\n' \
            f'<b>𝐓𝐎𝐓𝐀𝐋 𝐃𝐈𝐒𝐊 𝐒𝐏𝐀𝐂𝐄:</b> {total}\n' \
            f'<b>𝐔𝐒𝐄𝐃:</b> {used}  ' \
            f'<b>𝐅𝐑𝐄𝐄:</b> {free}\n\n' \
            f'📊𝐃𝐀𝐓𝐀 𝐔𝐒𝐀𝐆𝐄📊\n<b>Upload:</b> {sent}\n' \
            f'<b>𝐃𝐎𝐖𝐍🔻:</b> {recv}\n\n' \
...
/{BotCommands.ListCommand} [Search Keyword]: Searches the search term in the Google drive, if found replies with the link
